...
const TreatmentCards = ({ imageUrl, title, content,link }) => {
  return (
    <div className="w-[325px] h-[550px] relative font-primary">
      ...
      <div className="h-[126px] left-[24px] top-[321px] absolute">
        <div className="w-[277px] h-[91px] left-0 top-[35px] absolute text-neutral-600 text-base font-normal leading-snug">
          {content}
        </div>
